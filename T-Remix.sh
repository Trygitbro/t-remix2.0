...
echo " "
echo "
    WELCOME TO TERMUX BUDDY TOOLS_ SUBSCRIBE YOUTUBE CHANNEL
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY BETHAPUDI VIKRAM\e[m "
echo -e "\033[1;33m[*]setting termux as a real hacker \e[m"
echo -e "\033[1;33m[*]Please SUBSCRIBE TERMUX BUDDY channel for hacking tutorial! \e[m "
echo FINISHED !
echo -e "\033[1;32m                                                             
﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌﹌ \033[m "
sleep 4.0
...
echo -e "\e[32m     
    ...
    SUBSCRIBE TERMUX BUDDY channel for hacking and cyber security tutorials,ok?
                       ██╗      █████╗  ██████╗ ██╗███╗  ██╗
                       ██║     ██╔══██╗██╔════╝ ██║████╗ ██║
                       ██║     ██║  ██║██║  ██╗ ██║██╔██╗██║
                       ██║     ██║  ██║██║  ╚██╗██║██║╚████║
...
echo " "
echo "
        <─────────────── [Re-Coded by *•.¸♡ BETHAPUDI VIKRAM VARMA ♡¸.•* ] ───────────────>              
                            " |lolcat
...
tput cup 6 30
echo -e "\x1b[42m TERMUX BUDDY channel \x1b[m"
tput cup 9 0
...
tput cup 20 0
figlet -f slant "TERMUX BUDDY" |lolcat
echo " "
echo " "
#done setting up
